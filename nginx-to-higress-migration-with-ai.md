...
周五下午四点半，老板把一条 CNCF 公告甩到群里：

> **Ingress NGINX 将于 2025 年 3 月正式退役。**
> 
> 在 Ingress NGINX 停止支持后继续使用，将使你和你的用户面临安全攻击风险。现有替代方案都不是直接替换品，迁移需要时间和工程资源。大约一半的用户会受到影响。**你只有两个月的准备时间。**
