...
## Add New Models Anytime | 随时添加新模型
...
| Provider | Models | 供应商 | 模型 |
|----------|--------|--------|------|
| Zhipu AI | glm-* | 智谱 AI | glm-* |
| DeepSeek | deepseek-* | DeepSeek | deepseek-* |
| Moonshot | moonshot-*, kimi-* | 月之暗面 | moonshot-*, kimi-* |
| OpenAI | gpt-*, o1-*, o3-* | OpenAI | gpt-*, o1-*, o3-* |
| Anthropic | claude-* | Anthropic | claude-* |
| Google | gemini-* | Google | gemini-* |
| OpenRouter | All models | OpenRouter | 所有模型 |
| ...and more | | ...更多 | |
